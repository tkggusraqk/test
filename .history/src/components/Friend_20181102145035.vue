            ...
            <li class="condition_li" v-for="(item,index) in circleData" :key="item.id">
              ...
              <div class="condition_right">
                ...
                <div class="publishimg clear" v-show="item.imgs.length>0">
                  <div class="box-wrap">
                    <div class="box" v-for="value in item.imgs.split(',')" :key="value">
                      <div style="border:solid 1px red; height:100%;width:100%; overflow: hidden;"></div>
                      <!-- <img v-lazy="baseUrl+value" :key="value" alt="" style="width:100%; height:100%;"> -->
                    </div>
                  </div>
                </div>
