              ...
              <div class="condition_right">
                ...
                <div class="publishimg clear" v-show="item.imgs.length>0">
                  <ul class="mui-table-view mui-grid-view mui-grid-9">
                    <li class="mui-table-view-cell mui-media mui-col-xs-4 " v-for="value in item.imgs.split(',')">

                    </li>
                  </ul>
                  <img v-lazy="baseUrl+value" :key="value" alt=""  :class="{releaseimg : item.imgs.length >= 2 ? true : false}">
                </div>
