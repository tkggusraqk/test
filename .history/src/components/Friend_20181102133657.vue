          ...
          <ul>
            <li class="condition_li" v-for="(item,index) in circleData" :key="item.id">
              ...
              <div class="condition_right">
                ...
                <div class="publishimg clear" v-show="item.imgs.length>0" :key="index">
                  <template v-for="(value,index) in item.imgs.split(',')">
                    <div v-if="index!=0 && index%3===0" :key="index" style="display:display: block;"></div>
                    <img v-lazy="baseUrl+value" :key="value" alt="">
                  </template>
                </div>
